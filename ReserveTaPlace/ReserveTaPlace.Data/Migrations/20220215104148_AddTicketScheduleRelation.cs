...
{
    public partial class AddTicketScheduleRelation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieOrigins", x => new { x.MoviesId, x.OriginsId });
                    table.ForeignKey(
                        name: "FK_MovieOrigins_Movie_MoviesId",
                        column: x => x.MoviesId,
                        principalTable: "Movie",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieOrigins_Origin_OriginsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleSeats", x => new { x.SchedulesId, x.SeatsId });
                    table.ForeignKey(
                        name: "FK_ScheduleSeats_Schedule_SchedulesId",
                        column: x => x.SchedulesId,
                        principalTable: "Schedule",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduleSeats_Seat_SeatsId",
                        column: x => x.SeatsId,
                        principalTable: "Seat",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTheaters", x => new { x.TheatersId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_UserTheaters_Theater_TheatersId",
                        column: x => x.TheatersId,
                        principalTable: "Theater",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserTheaters_User_UsersId",
                        column: x => x.UsersId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomSeats", x => new { x.RoomsId, x.SeatsId });
                    table.ForeignKey(
                        name: "FK_RoomSeats_Room_RoomsId",
                        column: x => x.RoomsId,
                        principalTable: "Room",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomSeats_Seat_SeatsId",
                        column: x => x.SeatsId,
                        principalTable: "Seat",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieOrigins_OriginsId",
                table: "MovieOrigins",
                column: "OriginsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomSeats_SeatsId",
                table: "RoomSeats",
                column: "SeatsId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleSeats_SeatsId",
                table: "ScheduleSeats",
                column: "SeatsId");
